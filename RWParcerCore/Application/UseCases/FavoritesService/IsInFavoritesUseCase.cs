...
{
    internal class IsInFavoritesUseCase(IUserRepository userRepository, IFavoritesRepository favoriteRepository) : IIsInFavorites
    {
        ...
        public async Task<bool> IsInFavoritesAsync(string userId, TrainVO train)
        {
            ...
            return await _favoriteRepository.FavoriteExistsAsync(userId, train);
        }
    }
}
